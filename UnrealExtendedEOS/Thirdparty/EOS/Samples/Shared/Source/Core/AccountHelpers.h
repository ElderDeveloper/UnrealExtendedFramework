...
struct TEpicAccountId
{
	...
	*/
	...
	/** Allow direct comparison with raw account ID types to avoid C++20 ambiguity. */
	friend bool operator==(const TAccountType& Lhs, const TEpicAccountId& Rhs)
	{
		return Lhs == Rhs.AccountId;
	}
