 ...
 *
 * @see EOS_Leaderboards_QueryLeaderboardDefinitionsOptions
 * @see EOS_Leaderboards_OnQueryLeaderboardDefinitionsCompleteCallback
 */
 ...
 *
 * @see EOS_Leaderboards_GetLeaderboardDefinitionCountOptions
 ...
 *
 * @see EOS_Leaderboards_CopyLeaderboardDefinitionByIndexOptions
 ...
 *
 * @see EOS_Leaderboards_CopyLeaderboardDefinitionByLeaderboardIdOptions
 * @see EOS_Leaderboards_Definition
 * @see EOS_Leaderboards_Definition_Release
 *
 * @return EOS_EResult containing the result of the operation.
 ...
 * @param CompletionDelegate This function is called when the query operation completes.
 *
 * @see EOS_Leaderboards_QueryLeaderboardRanksOptions
 * @see EOS_Leaderboards_OnQueryLeaderboardRanksCompleteCallback
 */
 ...
 *
 * @see EOS_Leaderboards_GetLeaderboardRecordCountOptions
 ...
 *
 * @see EOS_Leaderboards_CopyLeaderboardRecordByIndexOptions
 ...
 *
 * @see EOS_Leaderboards_CopyLeaderboardRecordByUserIdOptions
 * @see EOS_Leaderboards_LeaderboardRecord
 * @see EOS_Leaderboards_LeaderboardRecord_Release
 *
 * @return EOS_EResult containing the result of the operation.
 ...
 * @param CompletionDelegate This function is called when the query operation completes.
 *
 * @see EOS_Leaderboards_QueryLeaderboardUserScoresOptions
 * @see EOS_Leaderboards_OnQueryLeaderboardUserScoresCompleteCallback
 */
 ...
 *
 * @see EOS_Leaderboards_GetLeaderboardUserScoreCountOptions
 ...
 *
 * @see EOS_Leaderboards_CopyLeaderboardUserScoreByIndexOptions
 * @see EOS_Leaderboards_LeaderboardUserScore
 * @see EOS_Leaderboards_LeaderboardUserScore_Release
 *
 * @return EOS_EResult containing the result of the operation.
 * Possible result codes:
 * - EOS_Success if the leaderboard scores are available and passed out in OutLeaderboardUserScore
 * - EOS_InvalidParameters if you pass a null pointer for the out parameter
 ...
 *
 * @see EOS_Leaderboards_CopyLeaderboardUserScoreByUserIdOptions
 * @see EOS_Leaderboards_LeaderboardUserScore
 * @see EOS_Leaderboards_LeaderboardUserScore_Release
 *
 * @return EOS_EResult containing the result of the operation.
