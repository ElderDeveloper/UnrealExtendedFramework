...
#include "Data/EFEnums.h"
#include "Backend/Json/EBJsonData.h"
 ...
 */
UCLASS()
class UNREALEXTENDEDFRAMEWORK_API UEBJsonLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	
	UFUNCTION(BlueprintCallable ,meta=(ExpandBoolAsExecs = "Success"), Category="Extended Framework | Backend | Json")
