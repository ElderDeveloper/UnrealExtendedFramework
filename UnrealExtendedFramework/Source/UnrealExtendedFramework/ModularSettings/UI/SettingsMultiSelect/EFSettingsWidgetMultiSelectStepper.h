...
#include "EFSettingsWidgetMultiSelectStepper.generated.h"

/**
 * 
 */
UCLASS()
class UNREALEXTENDEDFRAMEWORK_API UEFSettingsWidgetMultiSelectStepper : public UEFSettingsWidgetBase
{
	GENERATED_BODY()
