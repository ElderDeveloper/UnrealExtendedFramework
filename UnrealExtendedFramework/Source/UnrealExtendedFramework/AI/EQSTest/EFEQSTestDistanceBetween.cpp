...
#include "EFEQSTestDistanceBetween.h"
...
void UEFEQSTestDistanceBetween::FindActor(AActor*& Actor)
{

}

UEFEQSTestDistanceBetween::UEFEQSTestDistanceBetween(const FObjectInitializer& ObjectInitializer) :Super(ObjectInitializer)
{
...
void UEFEQSTestDistanceBetween::RunTest(FEnvQueryInstance& QueryInstance) const
{
...
FText UEFEQSTestDistanceBetween::GetDescriptionTitle() const
{
	return FText::FromString(FString::Printf(TEXT("From: To")));
}

FText UEFEQSTestDistanceBetween::GetDescriptionDetails() const
{
