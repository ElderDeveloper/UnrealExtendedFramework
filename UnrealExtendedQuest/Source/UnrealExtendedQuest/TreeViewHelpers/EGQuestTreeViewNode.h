...
class FEGQuestTreeViewNode : public TSharedFromThis<SelfType>
{
public:
	/* Create a listing for a search result*/
	FEGQuestTreeViewNode(const FText& InDisplayText, const TSharedPtr<SelfType>& InParent)
		: Parent(InParent), DisplayText(InDisplayText) {}
	virtual ~FEGQuestTreeViewNode() {}
