...
#include "EGQuestLocalizationHelper.h"
...
bool FEGQuestLocalizationHelper::WillTextNamespaceBeUpdated(const FText& Text)
{
	const auto* Settings = GetDefault<UEGQuestPluginSettings>();
	return WillTextNamespaceBeUpdated(Text, *Settings);
}

bool FEGQuestLocalizationHelper::WillTextNamespaceBeUpdated(const FText& Text, const UEGQuestPluginSettings& Settings)
{
	// Means we can override it
	return Settings.QuestTextNamespaceLocalization != EEGQuestTextNamespaceLocalization::Ignore &&
		   Settings.IsIgnoredTextForLocalization(Text);
}

void FEGQuestLocalizationHelper::UpdateTextFromRemapping(const UEGQuestPluginSettings& Settings, FText& OutText)
{
...
void FEGQuestLocalizationHelper::UpdateTextNamespaceAndKey(const UObject* Object, const UEGQuestPluginSettings& Settings, FText& Text)
{
...
bool FEGQuestLocalizationHelper::GetNewNamespaceAndKey(
	const UObject* Object,
	const UEGQuestPluginSettings& Settings,
	const FText& Text,
...
{
	static const FString DefaultValue = TEXT("");
	if (Settings.QuestTextNamespaceLocalization == EEGQuestTextNamespaceLocalization::Ignore)
	{
		return false;
	}
	...
	// Set new Namespace
	FString NewNamespace = Settings.QuestTextGlobalNamespaceName; // GlobalNamespace
	if (Settings.QuestTextNamespaceLocalization == EEGQuestTextNamespaceLocalization::PerQuest)
	{
		NewNamespace = Object->GetName();
	}
	else if (Settings.QuestTextNamespaceLocalization == EEGQuestTextNamespaceLocalization::WithPrefixPerQuest)
	{
		NewNamespace = Settings.QuestTextPrefixNamespaceName + Object->GetName();
	}
...
void FEGQuestLocalizationHelper::StaticStableTextId(const UObject* InObject, IEditableTextProperty::ETextPropertyEditAction InEditAction, const FString& InTextSource, const FString& InProposedNamespace, const FString& InProposedKey, FString& OutStableNamespace, FString& OutStableKey)
{
...
void FEGQuestLocalizationHelper::StaticStableTextId(const UPackage* InPackage, IEditableTextProperty::ETextPropertyEditAction InEditAction, const FString& InTextSource, const FString& InProposedNamespace, const FString& InProposedKey, FString& OutStableNamespace, FString& OutStableKey)
{
