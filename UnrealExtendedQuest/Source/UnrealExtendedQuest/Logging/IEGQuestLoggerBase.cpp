...
IEGQuestLoggerBase& IEGQuestLoggerBase::SetClientConsolePlayerController(APlayerController* PC)
{
	PlayerController = PC;
	return *this;
}

FOutputDevice* IEGQuestLoggerBase::GetOutputDeviceFromLogLevel(EEGQuestLogLevel Level)
{
#if NO_LOGGING
	return nullptr;
#else
	switch (Level)
	{
	case EEGQuestLogLevel::NoLogging:
		return nullptr;
...
#if WITH_UNREAL_DEVELOPER_TOOLS
FMessageLogModule* IEGQuestLoggerBase::GetMessageLogModule()
{
	return FModuleManager::LoadModulePtr<FMessageLogModule>("MessageLog");
}
#endif // WITH_UNREAL_DEVELOPER_TOOLS

bool IEGQuestLoggerBase::IsMessageLogNameRegistered(FName LogName)
{
#if WITH_UNREAL_DEVELOPER_TOOLS
...
void IEGQuestLoggerBase::MessageLogRegisterLogName(FName LogName, const FText& LogLabel, const FEGQuestMessageLogInitializationOptions& InitOptions)
{
#if WITH_UNREAL_DEVELOPER_TOOLS
	FMessageLogModule* MessageLogModule = GetMessageLogModule();
	if (!MessageLogModule)
...
bool IEGQuestLoggerBase::MessageLogUnregisterLogName(FName LogName)
{
#if WITH_UNREAL_DEVELOPER_TOOLS
	FMessageLogModule* MessageLogModule = GetMessageLogModule();
	if (!MessageLogModule)
...
#if WITH_UNREAL_DEVELOPER_TOOLS
TSharedPtr<IMessageLogListing> IEGQuestLoggerBase::MessageLogGetLogNameListing(FName LogName)
{
	FMessageLogModule* MessageLogModule = GetMessageLogModule();
	if (!MessageLogModule)
	{
...
void IEGQuestLoggerBase::MessageLogOpenLogName(FName LogName)
{
#if WITH_UNREAL_DEVELOPER_TOOLS
	FMessageLogModule* MessageLogModule = GetMessageLogModule();
	if (!MessageLogModule)
...
void IEGQuestLoggerBase::LogfImplementation(EEGQuestLogLevel Level, const TCHAR* Fmt, ...)
{
#if !NO_LOGGING
...
// void IEGQuestLoggerBase::Fatal(const ANSICHAR* File, int32 Line, const FString& Message)
// {
// #if NO_LOGGING
...
void IEGQuestLoggerBase::Log(EEGQuestLogLevel Level, const FString& Message)
{
	// Should not happen but just in case redirect to the fatal function
	// if (Level == EEGQuestLogLevel::Fatal)
	// {
...
void IEGQuestLoggerBase::LogScreen(EEGQuestLogLevel Level, const FString& Message)
{
	if (!GEngine)
	{
		return;
...
void IEGQuestLoggerBase::LogClientConsole(EEGQuestLogLevel Level, const FString& Message)
{
...
void IEGQuestLoggerBase::LogMessageLog(EEGQuestLogLevel Level, const FString& Message)
{
	// Should we be redirecting this message log because
	if (RedirectMessageLogLevelsHigherThan != EEGQuestLogLevel::NoLogging &&
...
void IEGQuestLoggerBase::LogOutputLog(EEGQuestLogLevel Level, const FString& Message)
{
...
void IEGQuestLoggerBase::ClearAllOnScreenLogs()
{
	if (!GEngine)
	{
		return;
