...
class FEGQuestTestHelper_ArrayEqualImpl
{
public:
		...
		std::function<bool(const ArrayType& FirstValue, const ArrayType& SecondValue, FString& ComparisonErrorMessage)> AreValuesEqual)
	{
		...
		if (FEGQuestHelper::IsArrayEqual<ArrayType>(ThisArray, OtherArray, AreValuesEqualWithoutMessage) == false)
		{
			bIsEqual = false;
...
template <typename ArrayType>
class FEGQuestTestHelper_ArrayPrimitiveVariantImpl
{
public:
	static bool IsEqual(const TArray<ArrayType>& ThisArray, const TArray<ArrayType>& OtherArray,
		...
		std::function<FString(const ArrayType&)> GetArrayTypeAsString)
	{
		return FEGQuestTestHelper_ArrayEqualImpl<ArrayType>::IsEqual(ThisArray, OtherArray, PropertyName, OutError, true, GetArrayTypeAsString,
...
// Variant for float
template <>
class FEGQuestTestHelper_ArrayPrimitiveVariantImpl<float>
{
public:
	...
	{
		return FEGQuestTestHelper_ArrayEqualImpl<float>::IsEqual(ThisArray, OtherArray, PropertyName, OutError, true, GetArrayTypeAsString,
...
struct FEGQuestTestHelper_SetEqualImpl
{
public:
	...
	{
		bool bIsEqual = true;
		if (FEGQuestHelper::IsSetEqual<SetType>(ThisSet, OtherSet) == false)
		{
			bIsEqual = false;
...
struct FEGQuestTestHelper_MapEqualImpl
{
public:
		...
		std::function<bool(const ValueType& FirstValue, const ValueType& SecondValue, FString& ComparisonErrorMessage)> AreValuesEqual)
	{
		...
		if (FEGQuestHelper::IsMapEqual<KeyType, ValueType>(ThisMap, OtherMap, AreValuesEqualWithoutMessage) == false)
		{
			bIsEqual = false;
...
// Variant with default comparison
template <typename KeyType, typename ValueType>
class FEGQuestTestHelper_MapPrimitiveVariantImpl
{
public:
	static bool IsEqual(const TMap<KeyType, ValueType>& ThisMap, const TMap<KeyType, ValueType>& OtherMap,
		const FString& PropertyName, FString& OutError,
		...
		std::function<FString(const ValueType&)> GetValueTypeAsString)
	{
		return FEGQuestTestHelper_MapEqualImpl<KeyType, ValueType>::IsEqual(ThisMap, OtherMap, PropertyName, OutError, true, GetKeyTypeAsString, GetValueTypeAsString,
...
class FEGQuestTestHelper_MapPrimitiveVariantImpl<KeyType, float>
{
public:
	...
	{
		return FEGQuestTestHelper_MapEqualImpl<KeyType, float>::IsEqual(ThisMap, OtherMap, PropertyName, OutError, true, GetKeyTypeAsString, GetValueTypeAsString,
...
public:
	...
	{
		return FEGQuestTestHelper_SetEqualImpl<SetType>::IsEqual(ThisSet, OtherSet, PropertyName, OutError, GetSetTypeAsString);
	}
	...
	static bool IsPrimitiveMapEqual(const TMap<KeyType, ValueType>& ThisMap, const TMap<KeyType, ValueType>& OtherMap,
		...
		std::function<FString(const ValueType&)> GetValueTypeAsString)
	{
		return FEGQuestTestHelper_MapPrimitiveVariantImpl<KeyType, ValueType>::IsEqual(ThisMap, OtherMap, PropertyName, OutError, GetKeyTypeAsString, GetValueTypeAsString);
	}
	...
	static bool IsComplexMapValueEqual(const TMap<KeyType, ValueType>& ThisMap, const TMap<KeyType, ValueType>& OtherMap,
		...
		std::function<FString(const ValueType&)> GetValueTypeAsString)
	{
		return FEGQuestTestHelper_MapEqualImpl<KeyType, ValueType>::IsEqual(ThisMap, OtherMap, PropertyName, OutError, false, GetKeyTypeAsString, GetValueTypeAsString,
			[](const ValueType& FirstMapValue, const ValueType& SecondMapValue, FString& ComparisonErrorMessage) -> bool
			{
	...
	static bool IsComplexPointersMapEqual(const TMap<KeyType, ValueType*>& ThisMap, const TMap<KeyType, ValueType*>& OtherMap,
		...
		std::function<FString(const KeyType&)> GetKeyTypeAsString)
	{
		return FEGQuestTestHelper_MapEqualImpl<KeyType, ValueType*>::IsEqual(ThisMap, OtherMap, PropertyName, OutError, false, GetKeyTypeAsString,
			[](const auto* Object) -> FString
			{
				return FEGQuestHelper::GetFullNameFromObject(Object);
			},
	...
	{
		return FEGQuestTestHelper_ArrayPrimitiveVariantImpl<ArrayType>::IsEqual(ThisArray, OtherArray, PropertyName, OutError, GetArrayTypeAsString);
	}
	...
	static bool IsComplexArrayEqual(const TArray<ArrayType>& ThisArray, const TArray<ArrayType>& OtherArray,
		const FString& PropertyName, FString& OutError)
	{
		return FEGQuestTestHelper_ArrayEqualImpl<ArrayType>::IsEqual(ThisArray, OtherArray, PropertyName, OutError, false,
