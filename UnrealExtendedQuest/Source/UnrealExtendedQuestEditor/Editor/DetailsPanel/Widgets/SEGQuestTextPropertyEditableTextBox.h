...
DECLARE_MULTICAST_DELEGATE_TwoParams(FEGQuestTextCommitedDelegate, const FText&, ETextCommit::Type);
DECLARE_MULTICAST_DELEGATE_OneParam(FEGQuestTextChangedDelegate, const FText&);


// Own STextPropertyEditableTextBox version with custom modifications
// Used to edit FText multiline FText instances
class UNREALEXTENDEDQUESTEDITOR_API SEGQuestTextPropertyEditableTextBox : public SCompoundWidget
{
	typedef SEGQuestTextPropertyEditableTextBox Self;

	SLATE_BEGIN_ARGS(SEGQuestTextPropertyEditableTextBox)
...
public:
	...
	FEGQuestTextCommitedDelegate& OnTextCommittedEvent() { return TextCommittedEvent; }
	FEGQuestTextChangedDelegate& OnTextChangedEvent() { return TextChangedEvent; }
...
protected:
	...
	FEGQuestTextChangedDelegate TextChangedEvent;
