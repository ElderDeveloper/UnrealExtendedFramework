...
#include "EGQuestObject_CustomRowHelper.h"
...
#define LOCTEXT_NAMESPACE "QuestObject_CustomRowHelper"
#define DEFAULT_FONT(...) FCoreStyle::GetDefaultFontStyle(__VA_ARGS__)

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// FEGQuestObject_CustomRowHelper
FEGQuestObject_CustomRowHelper::FEGQuestObject_CustomRowHelper(IDetailPropertyRow* InPropertyRow) :
	PropertyRow(InPropertyRow)
{
}

void FEGQuestObject_CustomRowHelper::Update()
{
...
UObject* FEGQuestObject_CustomRowHelper::GetObject() const
{
	if (!PropertyRow)
	{
		return nullptr;
...
UBlueprint* FEGQuestObject_CustomRowHelper::GetBlueprint() const
{
...
bool FEGQuestObject_CustomRowHelper::IsObjectABlueprint() const
{
	return GetBlueprint() != nullptr;
}

FReply FEGQuestObject_CustomRowHelper::OnBrowseClicked()
{
	if (!GEditor)
	{
...
FReply FEGQuestObject_CustomRowHelper::OnOpenClicked()
{
	if (UBlueprint* Blueprint = GetBlueprint())
	{
		FEGQuestEditorUtilities::OpenBlueprintEditor(
			Blueprint,
			OpenType,
			FunctionNameToOpen,
			bForceFullEditor,
...
FText FEGQuestObject_CustomRowHelper::GetBrowseObjectText() const
{
	return LOCTEXT("BrowseButtonToolTipText", "Browse to Asset in Content Browser");
}

FText FEGQuestObject_CustomRowHelper::GetJumpToObjectText() const
{
...
EVisibility FEGQuestObject_CustomRowHelper::GetOpenButtonVisibility() const
{
	if (!CanBeVisible())
	{
...
EVisibility FEGQuestObject_CustomRowHelper::GetBrowseButtonVisibility() const
{
	if (!CanBeVisible())
	{
		return EVisibility::Collapsed;
