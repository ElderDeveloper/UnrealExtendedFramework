...
#include "SEGQuestTextPropertyPickList.h"
...
#define LOCTEXT_NAMESPACE "SEGQuestTextPropertyPickList"

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// SEGQuestTextPropertyPickList
void SEGQuestTextPropertyPickList::Construct(const FArguments& InArgs)
{
...
FReply SEGQuestTextPropertyPickList::OnPreviewKeyDown(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
...
void SEGQuestTextPropertyPickList::SetText(const TAttribute<FText>& InNewText)
{
...
void SEGQuestTextPropertyPickList::SetToolTipAttribute(const TAttribute<FText>& InNewText)
{
	const FText NewText = InNewText.Get();
...
void SEGQuestTextPropertyPickList::SetPropertyHandle(const TSharedPtr<IPropertyHandle>& InPropertyHandle)
{
...
TSharedRef<SWidget> SEGQuestTextPropertyPickList::GetMenuWidget()
{
	// Is it cached?
...
TSharedRef<SWidget> SEGQuestTextPropertyPickList::GetContextCheckBoxWidget()
{
	// It is cached?
...
TSharedRef<SWidget> SEGQuestTextPropertyPickList::GetSearchBoxWidget()
{
	// Is it cached?
	if (InputTextWidget.IsValid())
	{
...
TSharedRef<SWidget> SEGQuestTextPropertyPickList::GetListViewWidget()
{
	// Is it cached?
...
TSharedRef<ITableRow> SEGQuestTextPropertyPickList::HandleListGenerateRow(TextListItem Text, const TSharedRef<STableViewBase>& OwnerTable)
{
	check(Text.IsValid());
...
void SEGQuestTextPropertyPickList::HandleMenuOpenChanged(bool bOpen)
{
	if (!bOpen)
	{
...
void SEGQuestTextPropertyPickList::HandleComboBoxOpened()
{
	GetSearchBoxWidget();
	FocusSearchBox();
...
void SEGQuestTextPropertyPickList::HandleTextChanged(const FText& InSearchText)
{
	UpdateSuggestionList();
...
/** Handler for when text in the editable text box changed */
void SEGQuestTextPropertyPickList::HandleTextCommitted(const FText& NewText, ETextCommit::Type CommitType)
{
	// Ignore default
...
FReply SEGQuestTextPropertyPickList::HandleKeyDown(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
...
void SEGQuestTextPropertyPickList::HandleListSelectionChanged(TextListItem NewValue, ESelectInfo::Type SelectInfo)
{
...
void SEGQuestTextPropertyPickList::HandleContextCheckboxChanged(ECheckBoxState CheckState)
{
...
void SEGQuestTextPropertyPickList::UpdateSuggestionList()
{
...
void SEGQuestTextPropertyPickList::FocusSearchBox() const
{
...
TSharedPtr<FString> SEGQuestTextPropertyPickList::GetSelectedSuggestion() const
{
