...
#include "EGQuestIntTextBox_CustomRowHelper.h"
...
#define LOCTEXT_NAMESPACE "QuestIntTextBox_CustomRowHelper"
#define DEFAULT_FONT(...) FCoreStyle::GetDefaultFontStyle(__VA_ARGS__)

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// FEGQuestMultiLineEditableTextBox_CustomRowHelper
void FEGQuestIntTextBox_CustomRowHelper::UpdateInternal()
{
...
FText FEGQuestIntTextBox_CustomRowHelper::GetResetToolTip() const
{
...
EVisibility FEGQuestIntTextBox_CustomRowHelper::GetDiffersFromDefaultAsVisibility() const
{
...
FReply FEGQuestIntTextBox_CustomRowHelper::OnResetClicked()
{
	if (PropertyHandle.IsValid())
	{
...
FReply FEGQuestIntTextBox_CustomRowHelper::OnJumpToNodeClicked()
{
	int32 NodeIndex = 0;
	if (PropertyHandle->GetValue(NodeIndex) == FPropertyAccess::Success)
	{
		FEGQuestEditorUtilities::JumpToGraphNodeIndex(Quest.Get(), NodeIndex);
	}
