 ...
 */
class UNREALEXTENDEDQUESTEDITOR_API FEGQuestBase_CustomRowHelper
{
	typedef FEGQuestBase_CustomRowHelper Self;
public:
	FEGQuestBase_CustomRowHelper(FDetailWidgetRow* InDetailWidgetRow, const TSharedPtr<IPropertyHandle>& InPropertyHandle);
	virtual ~FEGQuestBase_CustomRowHelper() {}
