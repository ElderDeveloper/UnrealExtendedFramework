 ...
 */
class UNREALEXTENDEDQUESTEDITOR_API SEGQuestTextPropertyPickList : public SCompoundWidget
{
	typedef TSharedPtr<FString> TextListItem;
	typedef SEGQuestTextPropertyPickList Self;
...
public:
	SLATE_BEGIN_ARGS(Self)
		...
		, _ContextCheckBoxText(NSLOCTEXT("SEGQuestTextPropertyPickList", "ContextCheckBoxText", "Local Search"))
		, _ContextCheckBoxToolTipText(NSLOCTEXT("SEGQuestTextPropertyPickList", "ContextCheckBoxToolTipText",
									 "Should the search be local? If not checked the search is global."))
		, _ToolTipText(NSLOCTEXT("SEGQuestTextPropertyPickList", "DefaultToolTip", "REPLACE ME"))
		, _HintText(NSLOCTEXT("SEGQuestTextPropertyPickList", "SearchBoxHint", "Search Names"))
