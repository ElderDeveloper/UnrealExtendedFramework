...
FText SEGQuestTextPropertyEditableTextBox::MultipleValuesText(NSLOCTEXT("PropertyEditor", "MultipleValues", "Multiple Values"));

void SEGQuestTextPropertyEditableTextBox::Construct(
	const FArguments& InArgs,
	const TSharedRef<FEGQuestEditableTextPropertyHandle>& InEditableTextProperty,
...
FText SEGQuestTextPropertyEditableTextBox::GetResetToolTip() const
{
...
EVisibility SEGQuestTextPropertyEditableTextBox::GetDiffersFromDefaultAsVisibility() const
{
...
FReply SEGQuestTextPropertyEditableTextBox::OnResetClicked()
{
...
EVisibility SEGQuestTextPropertyEditableTextBox::GetLocalizableVisibility() const
{
...
void SEGQuestTextPropertyEditableTextBox::GetDesiredWidth(float& OutMinDesiredWidth, float& OutMaxDesiredWidth)
{
	if (bIsMultiLine)
	{
...
bool SEGQuestTextPropertyEditableTextBox::SupportsKeyboardFocus() const
{
	return PrimaryWidget.IsValid() && PrimaryWidget->SupportsKeyboardFocus();
}

FReply SEGQuestTextPropertyEditableTextBox::OnFocusReceived(const FGeometry& MyGeometry, const FFocusEvent& InFocusEvent)
{
	// Forward keyboard focus to our editable text widget
	return FReply::Handled().SetUserFocus(PrimaryWidget.ToSharedRef(), InFocusEvent.GetCause());
}

void SEGQuestTextPropertyEditableTextBox::Tick(const FGeometry& AllottedGeometry, double InCurrentTime, float InDeltaTime)
{
...
bool SEGQuestTextPropertyEditableTextBox::CanEdit() const
{
	const bool bIsReadOnly = FTextLocalizationManager::Get().IsLocalizationLocked() || EditableTextProperty->IsReadOnly();
	return !bIsReadOnly;
}

bool SEGQuestTextPropertyEditableTextBox::IsCultureInvariantFlagEnabled() const
{
	return !IsSourceTextReadOnly();
}

bool SEGQuestTextPropertyEditableTextBox::IsSourceTextReadOnly() const
{
	if (!CanEdit())
	{
		return true;
...
bool SEGQuestTextPropertyEditableTextBox::WillNamespaceBeUpdated() const
{
	return !IsIdentityReadOnly() && FEGQuestLocalizationHelper::WillTextNamespaceBeUpdated(GetTextValue());
}

bool SEGQuestTextPropertyEditableTextBox::IsNamespaceReadOnly() const
{
	return IsIdentityReadOnly() || WillNamespaceBeUpdated();
}

bool SEGQuestTextPropertyEditableTextBox::IsIdentityReadOnly() const
{
	if (!CanEdit())
	{
		return true;
...
FText SEGQuestTextPropertyEditableTextBox::GetToolTipText() const
{
...
FText SEGQuestTextPropertyEditableTextBox::GetTextValue() const
{
	FText TextValue;
...
void SEGQuestTextPropertyEditableTextBox::SetTextValue(const FText& NewValue)
{
...
void SEGQuestTextPropertyEditableTextBox::OnTextChanged(const FText& NewText)
{
	const int32 NumTexts = EditableTextProperty->GetNumTexts();
...
void SEGQuestTextPropertyEditableTextBox::OnTextCommitted(const FText& NewText, ETextCommit::Type CommitInfo)
{
	const int32 NumTexts = EditableTextProperty->GetNumTexts();
...
void SEGQuestTextPropertyEditableTextBox::SetTextError(const FText& InErrorMsg)
{
	if (MultiLineWidget.IsValid())
	{
...
FText SEGQuestTextPropertyEditableTextBox::GetNamespaceValue() const
{
...
void SEGQuestTextPropertyEditableTextBox::OnNamespaceChanged(const FText& NewText)
{
	FText ErrorMessage;
...
void SEGQuestTextPropertyEditableTextBox::OnNamespaceCommitted(const FText& NewText, ETextCommit::Type CommitInfo)
{
...
FText SEGQuestTextPropertyEditableTextBox::GetKeyValue() const
{
	FText KeyValue;
...
void SEGQuestTextPropertyEditableTextBox::OnKeyChanged(const FText& NewText)
{
	FText ErrorMessage;
...
void SEGQuestTextPropertyEditableTextBox::OnKeyCommitted(const FText& NewText, ETextCommit::Type CommitInfo)
{
	if (!IsValidIdentity(NewText))
	{
		return;
...
FText SEGQuestTextPropertyEditableTextBox::GetPackageValue() const
{
	FText PackageValue;
...
ECheckBoxState SEGQuestTextPropertyEditableTextBox::GetLocalizableCheckState(bool bActiveState) const
{
	const int32 NumTexts = EditableTextProperty->GetNumTexts();
	if (NumTexts == 1)
	{
...
void SEGQuestTextPropertyEditableTextBox::HandleLocalizableCheckStateChanged(ECheckBoxState InCheckboxState, bool bActiveState)
{
	const int32 NumTexts = EditableTextProperty->GetNumTexts();
...
EVisibility SEGQuestTextPropertyEditableTextBox::GetNamespaceOverridenWarningImageVisibility() const
{
	// Nothing to show
...
EVisibility SEGQuestTextPropertyEditableTextBox::GetTextWarningImageVisibility() const
{
	const int32 NumTexts = EditableTextProperty->GetNumTexts();
...
bool SEGQuestTextPropertyEditableTextBox::IsValidIdentity(const FText& InIdentity, FText* OutReason, const FText* InErrorCtx) const
{
