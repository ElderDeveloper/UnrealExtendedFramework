...
class UNREALEXTENDEDQUESTEDITOR_API SEGQuestNodeOverlayWidget : public SCompoundWidget
{
	typedef SEGQuestNodeOverlayWidget Self;
...
public:
	...
	SLATE_BEGIN_ARGS(SEGQuestNodeOverlayWidget) {}
