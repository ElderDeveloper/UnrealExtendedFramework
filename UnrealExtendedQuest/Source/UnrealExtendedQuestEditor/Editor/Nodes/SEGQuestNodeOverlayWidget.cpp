...
/////////////////////////////////////////////////////
// SEGQuestNodeOverlayWidget
void SEGQuestNodeOverlayWidget::Construct(const FArguments& InArgs)
{
	...
	const FSlateBrush* CircleBrush = FEGQuestStyle::Get()->GetBrush(FEGQuestStyle::PROPERTY_GraphNodeCircleBox);
	ChildSlot
	[
		SNew(SOverlay)
		+SOverlay::Slot()
