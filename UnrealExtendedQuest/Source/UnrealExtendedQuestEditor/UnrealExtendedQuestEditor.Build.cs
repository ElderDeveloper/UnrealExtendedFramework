...
public class UnrealExtendedQuestEditor : ModuleRules
{
	public UnrealExtendedQuestEditor(ReadOnlyTargetRules Target) : base(Target)
	{
		// Enable IWYU
		...
		PrivateDependencyModuleNames.AddRange(
			new string[] {
				...
				"PropertyEditor",
				// The tag query customization swap (see EGQuestTagQuery_Details) reuses the
				// engine's SGameplayTagQueryEntryBox.
				"GameplayTagsEditor",
