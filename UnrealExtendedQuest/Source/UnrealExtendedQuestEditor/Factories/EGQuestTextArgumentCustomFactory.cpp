...
#include "EGQuestTextArgumentCustomFactory.h"
...
/////////////////////////////////////////////////////
// UEGQuestTextArgumentCustomFactory
UEGQuestTextArgumentCustomFactory::UEGQuestTextArgumentCustomFactory(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	bEditAfterNew = false;
	SupportedClass = UEGQuestTextArgumentCustom::StaticClass();

	// Default class
	ParentClass = SupportedClass;
}

bool UEGQuestTextArgumentCustomFactory::ConfigureProperties()
{
...
UObject* UEGQuestTextArgumentCustomFactory::FactoryCreateNew(
	UClass* Class,
	UObject* InParent,
	FName Name,
	EObjectFlags Flags,
