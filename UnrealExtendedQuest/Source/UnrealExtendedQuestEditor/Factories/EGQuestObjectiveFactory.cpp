...
#include "EGQuestObjectiveFactory.h"
...
/////////////////////////////////////////////////////
// UEGQuestObjectiveFactory
UEGQuestObjectiveFactory::UEGQuestObjectiveFactory(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	bEditAfterNew = false;
	SupportedClass = UEGQuestNode_Objective::StaticClass();

	// Default class
	ParentClass = SupportedClass;
}

bool UEGQuestObjectiveFactory::ConfigureProperties()
{
	static const FText TitleText = FText::FromString(TEXT("Pick Parent Class for Quest Objective"));
	ParentClass = nullptr;
...
UObject* UEGQuestObjectiveFactory::FactoryCreateNew(
	UClass* Class,
	UObject* InParent,
	FName Name,
	EObjectFlags Flags,
