...
#include "EGFeetIKAnimInstance.generated.h"

/**
 * 
 */
UCLASS()
class  UEGFeetIKAnimInstance : public UAnimInstance
{
	GENERATED_BODY()

	UEGFeetIKAnimInstance(const FObjectInitializer& ObjectInitializer);
