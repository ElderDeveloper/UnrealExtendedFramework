...
struct UNREALEXTENDEDEOS_API FEEOSResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSSessionSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSSessionSearchResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSLeaderboardEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSAchievement
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSFriendInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSPresenceInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSStat
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSSanction
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSVoiceDeviceInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSCatalogOffer
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSEntitlement
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSOwnership
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSUserInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALEXTENDEDEOS_API FEEOSExternalAccountMapping
{
	GENERATED_BODY()
