...
#include "EFAsyncVectorTimeline.generated.h"
...
class UEFAsyncVectorTimeline;
static TMap<int32,TWeakObjectPtr<UEFAsyncVectorTimeline>> EFVectorTimelines;

UCLASS()
class UNREALEXTENDEDFRAMEWORK_API UEFAsyncVectorTimeline : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	static UEFAsyncVectorTimeline* ExtendedFloatTimeline(UCurveVector* VectorCurve ,const UObject* WorldContextObject , float PassTime = 0.005 );
