...
void UUEExtendedEQSConeGeneratorDirection::GenerateItems(FEnvQueryInstance& QueryInstance) const
{
	...
	const FVector PawnForwardVector =BaseLocationIsContext? UUEExtendedMathLibrary::GetDirectionBetweenActors(TargetActor , AIPawn) :  UUEExtendedMathLibrary::GetDirectionBetweenActors(AIPawn , TargetActor);
...
FText UUEExtendedEQSConeGeneratorDirection::GetDescriptionTitle() const
{
	FString S = "Points: Cone Direction";
	return FText::FromString(S);
}

FText UUEExtendedEQSConeGeneratorDirection::GetDescriptionDetails() const
{
	FString S = "Points: Cone Direction";
	return FText::FromString(S);
	/*
