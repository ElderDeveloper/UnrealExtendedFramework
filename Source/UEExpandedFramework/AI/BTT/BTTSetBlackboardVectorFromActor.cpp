...
#include "BTTSetBlackboardVectorFromActor.h"
...
EBTNodeResult::Type UBTTSetBlackboardVectorFromActor::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
