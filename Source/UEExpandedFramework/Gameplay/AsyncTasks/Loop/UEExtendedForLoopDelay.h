...
#include "UEExtendedForLoopDelay.generated.h"
...
UCLASS()
class UEEXPANDEDFRAMEWORK_API UUEExtendedForLoopDelay : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	static UUEExtendedForLoopDelay* ForLoopWithDelay(const int32 FirstIndex , const int32 LastIndex ,const UObject* WorldContextObject , float Delay = 0.1);
