...
#include "GAAsycTaskCooldownChanged.generated.h"
...
class UEEXPANDEDFRAMEWORK_API UGAAsycTaskCooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	...
	static UGAAsycTaskCooldownChanged* GAListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags, bool UseServerCooldown);
