...
#include "GAAsycTaskEffectStackChanged.generated.h"
...
class UEEXPANDEDFRAMEWORK_API UGAAsycTaskEffectStackChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UGAAsycTaskEffectStackChanged* GAListenForGameplayEffectStackChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTag EffectGameplayTag);
