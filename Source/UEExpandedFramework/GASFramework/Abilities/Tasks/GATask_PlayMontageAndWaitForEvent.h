...
#include "GATask_PlayMontageAndWaitForEvent.generated.h"
...
UCLASS()
class UEEXPANDEDFRAMEWORK_API UGATask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	UGATask_PlayMontageAndWaitForEvent();
	...
	static UGATask_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent
	(
