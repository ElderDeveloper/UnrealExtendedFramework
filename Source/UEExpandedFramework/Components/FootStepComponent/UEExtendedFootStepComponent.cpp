...
#include "UEExtendedFootStepComponent.h"
...
bool UUEExtendedFootStepComponent::GetSurfaceEffects(const TEnumAsByte<EPhysicalSurface> surfaceType ,FFootStepStruct*& surfaceStruct) const
{
	if (FootStepTable)
	{
...
void UUEExtendedFootStepComponent::SpawnEffects(const FFootStepStruct* footStepStruct , const FLineTraceStruct* HitStruct)
{
