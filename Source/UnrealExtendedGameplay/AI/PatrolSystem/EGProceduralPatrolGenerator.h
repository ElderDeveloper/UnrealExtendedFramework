...
#include "EGProceduralPatrolGenerator.generated.h"
...
UCLASS()
class UNREALEXTENDEDGAMEPLAY_API AEGProceduralPatrolGenerator : public AActor
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AEGProceduralPatrolGenerator();
