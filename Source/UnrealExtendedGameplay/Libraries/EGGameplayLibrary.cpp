...
#include "EGGameplayLibrary.h"

#include "Kismet/GameplayStatics.h"



void UEGGameplayLibrary::ExtendedBlueprintLOG(TEnumAsByte<EExtendedLog> ExtendedLogType , FString Log)
{
...
void UEGGameplayLibrary::ExecuteFunction(UObject* RequestOwner , UObject* TargetObject, const FString FunctionToExecute)
{
...
float UEGGameplayLibrary::GetGameplayFramePerSecond(const UObject* WorldContextObject)
{
